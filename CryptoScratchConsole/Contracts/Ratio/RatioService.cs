...
using Contracts.Contracts.Ratio.ContractDefinition;

namespace Contracts.Contracts.Ratio
{
    public partial class RatioService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, RatioDeployment ratioDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<RatioDeployment>().SendRequestAndWaitForReceiptAsync(ratioDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, RatioDeployment ratioDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<RatioDeployment>().SendRequestAsync(ratioDeployment);
        }

        public static async Task<RatioService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, RatioDeployment ratioDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, ratioDeployment, cancellationTokenSource);
            return new RatioService(web3, receipt.ContractAddress);
        }
        ...
        public RatioService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
