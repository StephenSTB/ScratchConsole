...
using Contracts.Contracts.ScratchToken.ContractDefinition;

namespace Contracts.Contracts.ScratchToken
{
    public partial class ScratchTokenService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, ScratchTokenDeployment scratchTokenDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<ScratchTokenDeployment>().SendRequestAndWaitForReceiptAsync(scratchTokenDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, ScratchTokenDeployment scratchTokenDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<ScratchTokenDeployment>().SendRequestAsync(scratchTokenDeployment);
        }

        public static async Task<ScratchTokenService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, ScratchTokenDeployment scratchTokenDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, scratchTokenDeployment, cancellationTokenSource);
            return new ScratchTokenService(web3, receipt.ContractAddress);
        }
        ...
        public ScratchTokenService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
        ...
        public Task<string> MintRequestAsync(string receiver, BigInteger amount)
        {
